...
/**
 * For postfix mathematical operations as well as 
 * inplace operations.
*/
/*
static void postfix(bool canAssign) {
...
*/
ParseRule rules[] = {
    // Token type           Prefix     Infix   Postfix  Precedence
    ...
    [TOKEN_LEFT_BRACKET]  = {grouping, NULL,   NULL,    PREC_NONE}, // [
